...
export default class PanelShape extends Shape {
  ...
  constructor(model) {
    ...
    this.model.width = model.gabarit
      ? model.wardrobe.depth
      : model.wardrobe.depth - 100;
  ...
  drawSelf(ctx, realRect, screenRect, print = false) {
    ...
    const bottomRight = Geometry.realToScreen(
      this.rect.last,
      realRect,
      screenRect
    );
  ...
  setCaption() {
    ...
    const module =
      this.model.module && this.model.drawModule ? this.model.module : "";
