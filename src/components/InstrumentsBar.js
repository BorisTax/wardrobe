...
export default function InstrumentsBar(){
    ...
    const {createHorizontal: hor, createVertical: vert, createDrawer: drawer, createSingleDimension: single, createTwoPanelDimensionInside: twoInside, createTwoPanelDimensionOutside: twoOutside} = useSelector(store => store.toolButtonsPressed)
